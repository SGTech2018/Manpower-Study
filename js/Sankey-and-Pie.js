...
// *************************
  ...
  function drawTableChart(num){
    ...
    var position = headline.concat(num).slice(0,10);

    //Create a HTML Table element.
    var table = document.createElement("table");
    table.style.color = "white";
    table.style.background = "#7d5711";
...
$( document ).ready(function() {
   ...
   $(".show-button-group").click(function() {
      ...
      //'i' is the postion in the array, obj is the DOM object that you are iterating 
      $(this).html(all_jobs[i]);
  });
   	}
   	else{
...
for(i = 0; i < titles.length; i++){
	...
	if(index != 25 && index != 12 && index != 19 && index != 24 && index != 1){
		...
		for (t = 0; t < 20; t++){
            ...
            // don't have element
            j.push(temp_array[t][0]);
            counter_j.push(1);
        }
        if(m.indexOf(temp_array[t][1]) != -1){
            // have element
            index2 = m.indexOf(temp_array[t][1]);
            counter_m[index2] += 1;
        }
        else{
            // don't have element
        ...
        if(s.indexOf(temp_array[t][2]) != -1){
            // have element
            index2 = s.indexOf(temp_array[t][2]);
            counter_s[index2] += 1;
        }
        else{
            // don't have element
            s.push(temp_array[t][2]);
            counter_s.push(1);
        }
    }
}else{
...
for (i = 0; i < 10; i++){
	...
	for (i = 0; i< 10; i++){
		total_array2.push([total_array_j[i][0], total_array_m[i][0],total_array_s[i][0]]);
	}
}
drawTableChart(total_array2);
}
...
var data01_2 = new google.visualization.arrayToDataTable([
	['Skill', 'Junior', 'Middle', 'Senior', { role: 'annotation' } ],
	['java', 25.336, 9.823, 0.938, ''],
	['sql', 25.996, 8.843, 0.447, ''],
	['software development', 25.123, 9.227, 0.852, ''],
	['documentation', 20.52, 5.924, 0.256, ''],
	['communication skill', 16.003, 6.265, 0.426, ''],
	['javascript', 14.98, 5.924, 0.256, ''],
	['html', 15.065, 4.922, 0.341, ''],
	['c#', 15.47, 3.324, 0.298, ''],
	['oracle', 12.742, 5.007, 0.298, ''],
	['agile', 9.972, 5.775, 0.831, ''],
	]);
var data02_2 = new google.visualization.arrayToDataTable([
	['Skill', 'Junior', 'Middle', 'Senior', { role: 'annotation' } ],
	['sap', 13.283, 20.061, 0.783, ''],
	['communication skill', 14.407, 10.865, 1.158, ''],
	['information system', 8.958, 11.58, 0.954, ''],
	['documentation', 12.398, 8.14, 0.272, ''],
	['consulting', 7.289, 11.512, 0.681, ''],
	['sql', 10.729, 6.914, 0.545, ''],
	['oracle', 7.97, 8.753, 1.09, ''],
	['java', 7.187, 5.552, 0.579, ''],
	['reporting', 6.403, 5.177, 0.477, '']
	]);
var data03_2 = new google.visualization.arrayToDataTable([
	['Skill', 'Junior', 'Middle', 'Senior', { role: 'annotation' } ],
	['troubleshooting', 23.933, 6.972, 0.468, ''],
	['communication skill', 18.887, 5.723, 0.676, ''],
	['documentation', 18.991, 5.307, 0.78, ''],
	['linux', 12.279, 5.515, 0.676, ''],
	['operating system', 13.944, 3.018, 0.52, ''],
	['active directory', 13.736, 3.382, 0.312, ''],
	['vmware', 11.446, 4.579, 0.52, ''],
	['scripting', 9.261, 5.307, 0.156, ''],
	['information system', 10.77, 3.174, 0.728, ''],
	['firewall', 11.134, 2.601, 0.416, '']
	]);
var data04_2 = new google.visualization.arrayToDataTable([
	['Skill', 'Junior', 'Middle', 'Senior', { role: 'annotation' } ],
	['project management', 30.138, 21.61, 5.244, ''],
	['communication skill', 21.133, 12.871, 2.648, ''],
	['reporting', 11.811, 8.528, 2.913, ''],
	['documentation', 14.142, 6.727, 1.642, ''],
	['software development', 10.646, 7.256, 2.066, ''],
	['leadership', 6.197, 9.004, 3.125, ''],
	['information system', 8.21, 7.68, 1.165, ''],
	['pmp', 7.521, 6.621, 1.324, ''],
	['problem solving', 8.369, 3.972, 1.589, '']
	]);
var data05_2 = new google.visualization.arrayToDataTable([
	['Skill', 'Junior', 'Middle', 'Senior', { role: 'annotation' } ],
	['communication skill', 16.129, 8.739, 3.167, ''],
	['documentation', 12.317, 5.103, 1.056, ''],
	['java', 9.208, 5.63, 2.053, ''],
	['software development', 9.091, 5.455, 1.877, ''],
	['troubleshooting', 13.079, 2.874, 0.469, ''],
	['linux', 11.73, 4.34, 0.235, ''],
	['sql', 8.915, 5.161, 1.232, ''],
	['information system', 8.446, 4.692, 1.584, ''],
	['leadership', 6.276, 5.103, 2.698, ''],
...
var data07_2 = new google.visualization.arrayToDataTable([
	...
	['communication skill', 22.801, 7.405, 0.44, ''],
	['sql', 22.654, 7.478, 0.22, ''],
	['software development', 18.988, 7.185, 1.1, ''],
	['java', 18.402, 7.185, 0.073, ''],
	['oracle', 17.375, 5.499, 0.587, ''],
	['software development life cycle', 14.809, 5.792, 1.026, ''],
	['reporting', 12.683, 4.179, 0.147, ''],
	['application development', 11.07, 3.886, 0.073, ''],
	['information system', 9.971, 4.472, 0.147, '']
	]);
var data08_2 = new google.visualization.arrayToDataTable([
	['Skill', 'Junior', 'Middle', 'Senior', { role: 'annotation' } ],
	['communication skill', 23.9, 7.185, 1.833, ''],
	['marketing', 17.375, 7.331, 2.786, ''],
	['business development', 10.337, 7.405, 2.786, ''],
	['leadership', 6.891, 5.499, 3.006, ''],
	['information system', 9.091, 4.032, 0.953, ''],
	['reporting', 8.504, 3.886, 1.613, ''],
	['crm', 8.504, 2.566, 0.733, ''],
	['account management', 6.085, 3.226, 1.466, ''],
	['project management', 6.158, 3.006, 1.466, '']
	]);
var data09_2 = new google.visualization.arrayToDataTable([
	['Skill', 'Junior', 'Middle', 'Senior', { role: 'annotation' } ],
	['business requirement', 27.613, 12.433, 0.915, ''],
	['documentation', 24.18, 10.221, 0.839, ''],
	['communication skill', 17.696, 14.874, 0.915, ''],
	['business process', 20.366, 9.23, 0.992, ''],
	['software development', 18.383, 8.162, 0.305, ''],
	['sql', 16.781, 6.484, 0.381, ''],
	['software development life cycle', 15.256, 6.941, 0.305, ''],
	['business analysis', 13.577, 7.399, 0.915, ''],
	['information system', 11.823, 9.001, 0.61, ''],
	['reporting', 11.747, 8.391, 1.068, '']
	]);
var data10_2 = new google.visualization.arrayToDataTable([
	...
	['Reporting', 12.261, 6, 0.609, ''],
	['Agile', 9.478, 7.043, 0.435, ''],
	['SQL', 9.391, 6.087, 0.348, ''],
	['Java', 8.957, 6.435, 0.261, ''],
	['Quality Assurance', 10.87, 3.913, 0.609, '']
	]);
  ...
  google.charts.setOnLoadCallback(drawSankeyChart(data01));
  google.charts.setOnLoadCallback(drawPieChart3(data01_1));
  google.charts.setOnLoadCallback(drawStackChart(data01_2));
  ...
  if (row >= 1 && row <= 10){
          ...
          function drawSankeyChart(title) {
                ...
                //$('#sankeychart_div').css("padding-left", "95");
              ...
              var piechart_options2 = {
               ...
               tooltip:{textStyle:{color:'white'}, showColorCode: true},
               pieHole: 0.4,
           };          
              // Instantiate and draw our chart, passing in some options.
